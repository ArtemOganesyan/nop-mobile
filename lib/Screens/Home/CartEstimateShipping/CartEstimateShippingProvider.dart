...
class CartEstimateShippingProvider extends ChangeNotifier {
  ...
  initMethode({required BuildContext context})async{
    ...
    if(await CheckConnectivity().checkInternet(context)){
      ...
      estimateShippingResponseModel.countryId = estimateShippingResponseModel.countryId == null ? 0 : estimateShippingResponseModel.countryId;
  ...
  productEstimateShippingData({required BuildContext context}) async {
    ...
    if(estimateShippingResponseModel.countryId != 0 && estimateShippingResponseModel.zipPostalCode.isNotNullOrEmpty() )
    {
