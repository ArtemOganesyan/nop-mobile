...
class WishlistProvider extends ChangeNotifier {
  ...
  sharedWishlist({required BuildContext context}) async
  {
    ...
    // await Share.share(wishlistShareURL.trim()).then((value){
    //   print("SHARE CLOSED");
    // });
    final box = context.findRenderObject() as RenderBox?;
    await Share.shareWithResult(wishlistShareURL.trim(),sharePositionOrigin: box!.localToGlobal(Offset.zero) & box.size,);
    print("SHARE CLOSED");
