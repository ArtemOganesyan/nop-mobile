...
class ProductBoxModel {
  ...
  factory ProductBoxModel.fromJson(Map<String, dynamic> json) => ProductBoxModel(
    ...
    // pictureModels: List<PictureModel>.from(json["DefaultPictureModel"].map((x) => PictureModel.fromJson(x))),
    pictureModels: [PictureModel.fromJson(json["DefaultPictureModel"])],
