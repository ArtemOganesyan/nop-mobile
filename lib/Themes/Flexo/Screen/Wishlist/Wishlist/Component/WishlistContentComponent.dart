          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: ()async{
                    if(!wishlistProvider.isAPILoader && wishlistProvider.isShareModalOpened==false) {
                      wishlistProvider.isShareModalOpened = true;
                      await wishlistProvider.sharedWishlist(context: context);
                      wishlistProvider.isShareModalOpened = false;
                    }
                  },
                  child: Container(
